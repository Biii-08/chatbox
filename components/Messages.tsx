...
const Messages = () => {
  return (
    <div>
      <div className="flex flex-row w-96 flex-shrink-0 bg-gray-100  dark:bg-[#637685] [#0B0E14] dark:text-white p-4">
        <div className="flex flex-col w-full h-full pl-4 pr-4 py-4 -mr-4">
          ...
          <div className="mt-5">
            <div className="text-xs text-gray-400 dark:text-slate-300 font-semibold uppercase">
              Team
            </div>
          </div>
          <div className="mt-2">
