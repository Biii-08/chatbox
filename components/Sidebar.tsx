...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-row h-screen antialiased bg-white dark:bg-[#637685] text-gray-800">
      <div className="flex flex-col items-center py-4 flex-shrink-0 w-20 dark:bg-[#26264c]  bg-indigo-800 rounded-3xl ">
        <a
          href="#"
